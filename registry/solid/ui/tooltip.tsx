...
function Tooltip(props: ParentProps<{ [key: string]: any }>) {
  return <TooltipPrimitive.Root data-slot="tooltip" {...props} />
}

function TooltipTrigger(props: ParentProps<{ [key: string]: any }>) {
  return <TooltipPrimitive.Trigger data-slot="tooltip-trigger" {...props} />
}

function TooltipContent(props: ParentProps<{ class?: string; [key: string]: any }>) {
